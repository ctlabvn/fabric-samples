...
router.post("/channels/:channelName/peers", function(req, res) {
    ...
    join
        .joinChannel(channelName, peers, req.username, req.orgname)
        .then(function(message) {
            res.send(message);
        });
});
    ...
    if (isUpgrade) {
        install
            ...
            .then(function(message) {
                ...
                if (
                    !message ||
                    !message.includes("Successfully Installed chaincode")
                ) {
                    res.send(
                        "Chaincode upgarde failed while installing chaincode with version " +
                            chaincodeVersion
                    );
                } else {
                    instantiate
...
router.get("/channels/:channelName/chaincodes/:chaincodeName", function(
    req,
    res
) {
...
router.get("/channels/:channelName/blocks/:blockId", function(req, res) {
    ...
    query
        .getBlockByNumber(peer, channelName, blockId, req.username, req.orgname)
        .then(function(message) {
            res.send(message);
        });
});
...
router.get("/channels/:channelName/blocks", function(req, res) {
    ...
    query
        .getBlockByHash(peer, hash, req.username, req.orgname, channelName)
        .then(function(message) {
            res.send(message);
        });
});
...
router.get("/channels/:channelName", function(req, res) {
    ...
    logger.debug("channelName : " + channelName);
    query
        .getChainInfo(peer, channelName, req.username, req.orgname)
        .then(function(message) {
            res.send(message);
        });
});
...
router.get("/channels/:channelName/height", function(req, res) {
    ...
    query
        .getChannelHeight(peer, channelName, req.username, req.orgname)
        .then(function(message) {
            res.send(message);
        });
});
